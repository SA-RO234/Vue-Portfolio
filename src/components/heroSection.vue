...
<template>
  <section class="relative w-full" data-aos="zoom-in-up">
    <div class="absolute top-0 inset-x-0 h-64 flex items-start">
      ...
      ></div>
      <div
        class="h-24 w-3/5 bg-gradient-to-r from-[#670ccf] opacity-40 blur-2xl"
      ></div>
    </div>
    <div
    ...
    >
      ...
      >
        <div class="lg:py-6">
          ...
          <p
            class="text-gray-300 pt-8 text-center lg:text-left max-w-xl"
          >
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fugiat
            cupiditate praesentium, placeat ratione necessitatibus vitae illum,
            modi quas adipisci rerum beatae debitis tempore nihil architecto
          </p>
          <div
          ...
          >
            ...
            >
              ...
              >
                ...
                <a
                  href="/src/assets/CURRICULUM _VITAE New.pdf"
                  download="CURRICULUM _VITAE New.pdf"
